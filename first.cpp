...
main( int argc, char *argv[ ] )
{
    ...
    char *array_mult = (char *)"ArrayMult";
    char *array_mult_add = (char *)"ArrayMultAdd";
    char *function;
    bool a = false;
	...
	if(a){
		...
		for(int i = 0; i < NUM_ELEMENTS; i++ ) sum += hC[i];
	}
...
*/
	fprintf( stderr, "%8d\t%4d\t%10d\t%10.3lf GigaMultsPerSecond\n",
		condition, NUM_ELEMENTS, LOCAL_SIZE, (double)NUM_ELEMENTS/(time1-time0)/1000000000. );
